class ReconhecerController {
  ...
  verificaImagemB64() {
    ...
    $.ajax({
        url: 'https://watson-api-explorer.mybluemix.net/visual-recognition/api/v3/classify?api_key=13716f028397a98e84d3ce2c39e672c5e021845e&classifier_ids=PESSOAS_1462124818&version=2016-05-20',
        type: 'post',
        data: {
  ...
  verificaImagem(url) {
    ...
    $.ajax({
        ...
        url: 'https://watson-api-explorer.mybluemix.net/visual-recognition/api/v3/classify?api_key=13716f028397a98e84d3ce2c39e672c5e021845e&url='+url+'&classifier_ids=PESSOAS_1462124818&version=2016-05-20&threshold=0.7',
        type: 'get',
        dataType: 'json',
        success: function(response) {
